...
export default function Navbar() {
   const { user } = useUser();
   return (
      <div className="sticky top-0 flex items-center justify-center bg-background z-50">
         <header className="flex items-center justify-between w-[min(1200px,90%)] h-16">
            <Logo />

            <div className="flex items-center gap-4">
               <Button variant="outline">
                  <Plus />
                  <span className="hidden sm:block">Add Spot</span>
               </Button>
               <Button variant="outline">
                  <svg
