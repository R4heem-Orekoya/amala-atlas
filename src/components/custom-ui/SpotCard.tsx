...
export default function SpotCard({ spot, className, mapRef }: SpotCardProps) {
      ...
      <div className={cn("px-4 py-5 mt-4 border rounded-lg", className)}>
         ...
         <div className="flex justify-between items-start">
            <div className="w-full flex items-center gap-2">
               <span className="grid place-items-center size-7 shrink-0 rounded-full bg-rose-500/20 text-rose-500">
         ...
         <div className="flex gap-2">
            <NavigateButton spot={spot} mapRef={mapRef} />
