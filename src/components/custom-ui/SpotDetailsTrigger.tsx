...
export function SpotDetailsTrigger({
  ...
  function upvote(spotId: Doc<"spots">["_id"]) {
    void upvoteMutation({
      ...
      toast.error(
        error instanceof ConvexError ? error.message : "Couldn't upvote spot!"
      );
    });
  }
  ...
  function downvote(spotId: Doc<"spots">["_id"]) {
    void downvoteMutation({
      ...
      toast.error(
        error instanceof ConvexError ? error.message : "Couldn't downvote spot!"
      );
    });
  }
  ...
  function addToBookmark(spotId: Doc<"spots">["_id"]) {
    void bookmarkMutation({
      ...
      toast.error(
        error instanceof ConvexError ? error.message : "Couldn't bookmark spot!"
      );
    });
  }
                      ...
                      <div className="relative w-full h-52">
                        ...
                        <Image
                          ...
                          className={cn(
                            ...
                            loadedImages[img._id] ? "opacity-100" : "opacity-0"
                          )}
                          onClick={() => {
                            setFullLoaded(false);
              ...
              >
                <HugeiconsIcon
                  ...
                  className={cn({
                    "fill-emerald-500":
                      user &&
                      upvotes.some((upvote) => upvote.userId === user?.id),
                  })}
                />
